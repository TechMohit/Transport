...
public class HpTermination extends AppCompatActivity {
    ImageView logo;
    TextView textid2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hp_termination);
        ...
        logo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(HpTermination.this,MainActivity.class);
                startActivity(intent);
            }
        });
        String text2 = "Attested Copy of PAN card of Form 60 and Form 61 (as applicable)*";
