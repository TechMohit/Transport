...
public class DuplicateRc extends AppCompatActivity {
    ImageView logo;
    TextView textid2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_duplicate_rc);
        ...
        logo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(DuplicateRc.this,MainActivity.class);
